...
class NavigationRouter extends _i2.RootStackRouter {
  ...
  List<_i2.RouteConfig> get routes => [
        _i2.RouteConfig(BottomNavigationHome.name, path: '/', children: [
...
class BottomNavigationHome extends _i2.PageRouteInfo<void> {
  const BottomNavigationHome({List<_i2.PageRouteInfo>? children})
